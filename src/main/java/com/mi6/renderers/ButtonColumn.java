...
public class ButtonColumn extends AbstractCellEditor
	...
	public ButtonColumn(JTable table, Action action, int column) {
		...
		editButton.setFont(new Font(Util.FONT_NAME, Font.BOLD, Util.FONT_SIZE));
		renderButton.setFont(new Font(Util.FONT_NAME, Font.BOLD, Util.FONT_SIZE));
	}
